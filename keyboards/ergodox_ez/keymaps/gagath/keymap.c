 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Esc  |  '"  | Left | Right|AltShf|                                       | RAlt | Up   | Down |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LCTL,         KC_Z,        KC_X,          KC_C,    KC_V,           KC_B,    ALL_T(KC_NO),                    MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  KC_ESC,          KC_QUOT,     KC_LEFT,       KC_LALT, LALT(KC_LSFT),                                            KC_RALT,   KC_UP,   KC_DOWN, KC_RBRC, TT(SYMB),
